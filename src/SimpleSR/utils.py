...
) -> tuple[nn.Module, nn.Module, Any, Any, Any, Optimizer | None, Any] | tuple[nn.Module, Any, Any, Any, Optimizer | None, Any] | nn.Module:
    # Load model weights
    checkpoint = th.load(model_weights_path, map_location=lambda storage, loc: storage)
